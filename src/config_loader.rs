...
pub struct AppConfig {
    pub models: HashMap<String, String>,          // lang -> model name
    pub kreza_use_ensemble: bool,
    pub kreza_ensemble_models: Vec<String>,
    pub evolution_cycles: u64,
    pub lite_mode: bool,                          // وضع خفيف للأجهزة الضعيفة
    pub energy_costs: HashMap<String, u32>,       // تكلفة كل نموذج (للطاقة)
}
...
impl Default for AppConfig {
    fn default() -> Self {
        ...
        energy.insert("deepseek-coder:6.7b".into(), 6);
        AppConfig {
            models,
